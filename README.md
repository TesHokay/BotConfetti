...
2. **Запустите экспорт.** Бот соберёт все заявки и добавит в колонку «Фото оплаты» кликабельную ссылку на подтверждение платежа. Если фото не прикреплено, в таблице появится текст «Оплата ожидается».
...
### Советы по совместной работе с таблицей

- Если нужно общее хранилище, можно вручную загрузить присланный XLSX в Google Drive, Dropbox или другую облачную папку и поделиться доступом с коллегами.
- Чтобы всегда иметь под рукой последнюю версию, закрепите сообщение бота с таблицей или сохраните его в «Избранном».
